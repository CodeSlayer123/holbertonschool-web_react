...
export function mapStateToProps(state){
  ...
  export const mapDispatchToProps = (dispatch) => {
    return {
        ...
        markNotificationAsRead: (notifications) => dispatch(markAsAread(notifications))
    }
  }

  export const ConnectedNotifs = connect(mapStateToProps, mapDispatchToProps)(Notifications);
