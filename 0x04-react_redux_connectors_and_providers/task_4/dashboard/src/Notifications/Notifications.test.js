...
describe('Tests Notifications ', () => {
    ...
    describe('Notifications renders three list items', () => {
      ...
      describe('tests handleDisplayDrawer & handleHideDrawer task 0', () => {
        it('tests handleDisplayDrawer & handleHideDrawer task 0', function(){
            const wrapper = shallow(<Notifications displayDrawer={false} />);
            wrapper.find('.notifs').simulate('click')
            assert.equal(wrapper.state('displayDrawer'), true);
            wrapper.find('.close').simulate('click')
            assert.equal(wrapper.state('displayDrawer'), false);
        });
      });
